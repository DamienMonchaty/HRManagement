...
namespace HRManagement.Business.Migrations
{
    ...
    [Migration("20221026123555_init4")]
    partial class init4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRManagement.Common.Models.EmployeeProject", b =>
                {
            ...
            modelBuilder.Entity("HRManagement.Common.Models.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HRManagement.Common.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "prenom1",
                            Nationality = "Nat1",
                            Password = "$2a$11$UdA/a5pr1Lfg6qeBk6qUJuu/oe8Mcmjt8Gx4vOmZCsoJDWpHB51De",
                            Role = "User",
                            Sexe = "sexe1",
                            UserName = "prenom1"
                        },
                        new
                        {
                            ...
                            LastName = "prenom2",
                            Nationality = "Nat2",
                            Password = "$2a$11$LM1dDJV/t1ARh2QIyfoideSAlE52buGAShOkSJjdBfXKV3Z0.E0ia",
                            Role = "Admin",
                            Sexe = "sexe1",
                            UserName = "prenom2"
                        },
                        new
                        {
                            ...
                            LastName = "prenom3",
                            Nationality = "Nat3",
                            Password = "$2a$11$kvedbquiqIpQruUmM4CIIe/x7twDqocaiTGWrKC7H.0apO5M8fPhK",
                            Role = "Admin",
                            Sexe = "sexe3",
                            UserName = "prenom3"
                        });
            ...
            modelBuilder.Entity("HRManagement.Common.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "prenom4",
                            Nationality = "Nat2",
                            Password = "$2a$11$eKe6/MTorHhqY10MGJyIaODuutAn3X1HERz.I04xcFtTyP3hWMTdO",
                            Role = "User",
                            Sexe = "sexe2",
                            UserName = "prenom4",
                        ...
                        new
                        {
                            ...
                            LastName = "prenom5",
                            Nationality = "Nat1",
                            Password = "$2a$11$VaBXztGHIWhPX5kqs.../.oiZ0YtMLDv6zNw3YAkS7.DxrzgY5HqK",
                            Role = "User",
                            Sexe = "sexe1",
                            UserName = "prenom5",
                            AdditionalIndemnity = 200.0,
                        ...
                        new
                        {
                            ...
                            LastName = "prenom6",
                            Nationality = "Nat2",
                            Password = "$2a$11$RH4TsGxN3g1e/0TD6FhLTu7A1RXGB.cEAl34xtPJRp3jR9GXJrSEW",
                            Role = "User",
                            Sexe = "sexe6",
                            UserName = "prenom6",
                            AdditionalIndemnity = 200.0,
            ...
            modelBuilder.Entity("HRManagement.Common.Models.EmployeeProject", b =>
                {
                    ...
                    b.HasOne("HRManagement.Common.Models.Project", "Project")
                        .WithMany("EmployeeProjects")
